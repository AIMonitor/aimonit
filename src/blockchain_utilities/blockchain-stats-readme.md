...
See also the utility's help option. `aimonit-blockchain-stats --help`

From the command line run:

`$ aimonit-blockchain-stats`
...
- `aimonit-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `aimonit-blockchain-stats | save-to-database.sh`
